...
tasks = ['Validation', 'ScratchItch', 'BedBathing', 'Feeding', 'Drinking', 'Dressing', 'ArmManipulation', 'ChestCleaning']
...
for task in ['ScratchItch', 'Feeding', 'Validation', 'ChestCleaning']:
    for robot in robots:
        register(
